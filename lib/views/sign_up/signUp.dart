    ...
    return Form(
      ...
      child: Column(
        children: [
          // First Name
          TextFormField(
            onChanged: (value) => controller.firstName = value as RxString,
            decoration: const InputDecoration(
              labelText: "First Name",
              hintText: "Enter your first name",
              suffixIcon: Padding(padding: EdgeInsets.all(15), child: Icon(Icons.person_outline)),
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              ...
              suffixIcon: Padding(padding: EdgeInsets.all(15), child: Icon(Icons.email_outlined)),
              border: authOutlineInputBorder,
            ),
          ),
          const SizedBox(height: 20),
