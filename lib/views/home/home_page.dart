import 'package:ecomapp/views/home/widget/home_header.dart';
import 'package:ecomapp/views/home/widget/popularproducts.dart';
import 'package:ecomapp/views/home/widget/recently_added_products.dart';
...
class CategoryWidget extends StatelessWidget {
  final ProductController controller = Get.find<ProductController>();
  final List<String> categories = ['All', 'Electronics', 'Clothing', 'Books', 'Parfum'];
          ...
          return Padding(
            ...
            child: Obx(() => ChoiceChip(
              ...
              labelStyle: TextStyle(
                  color: controller.selectedCategoryIndex.value == index ? Colors.white : Colors.black
              ),
            )),
          );
        },
