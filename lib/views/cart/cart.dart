      ...
      body: Padding(
        ...
        child:Obx(() => ListView.builder(
          ...
          itemBuilder: (context, index) => Padding(
            ...
            child: Dismissible(
              key: Key(
                controller.cartProducts[index].product.id.toString(),
              ),
              ...
              child: CartCard(cart: controller.cartProducts[index]),
            ),
          ),
        ),
      ),),
              ...
              children: [
                ...
                Expanded(
                  child: Obx(() => Text.rich(
                    TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text: "\$${controller.totalPrice}", // .value si c'est un RxDouble
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    onPressed: () {controller.addToCart(Product as Product);},
